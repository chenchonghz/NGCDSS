(defrule MS_Hypertension_Instance_70024_0
(filepath ?filepath)
...
(if(NotifyOrNot equals ?Threshhold 1 ?ShortData ?filepath Hypertension_Instance_70024)
then
(undefrule *)
(InterpretationIndex "高血压1级或2级，诊断为高危。")
...
(defrule MS_Hypertension_Instance_70024_1
(filepath ?filepath)
(hypertension_Diagnose_Stage ?hypertension_Diagnose_Stage)
=>
(bind ?Threshhold 0)
