(defrule MS_MS_mergexml_Instance_170061_0
(filepath ?filepath)
...
(if(NotifyOrNot >= ?Threshhold 1 ?ShortData ?filepath MS_mergexml_Instance_170061)
then
(undefrule *)
...
(defrule MS_MS_mergexml_Instance_170061_1
(filepath ?filepath)
(abnormal_renal_function ?abnormal_renal_function)
=>
(bind ?Threshhold 0)
...
(undefrule *)
(InterpretationIndex "NO_VALUE")
(load (str-cat ?filepath "MS_MS_mergexml_Instance_170063.clp"))
(FactUsed "abnormal_renal_function")
)
)
