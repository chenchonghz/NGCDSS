...
namespace CDSSFunction
{
    public class Interface
    {
        ...
        public static bool SetInferenceNeededEvents(List<FunctionTypeDef.EventModels> lstCDSSEvents)
        {
            ...
            oRole.oPatient.strPatName = GlobalData.PatBasicInfo.PatName;
            oRole.oPatient.strPatID = GlobalData.PatBasicInfo.PatID;
            oRole.oPatient.dtPatBirthday = GlobalData.PatBasicInfo.PatBirthday;
            oRole.oPatient.strPatSex =  GlobalData.PatBasicInfo.PatSex;
