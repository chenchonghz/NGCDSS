(defrule MS_MS_mergexml_Instance_170026_0
(filepath ?filepath)
(Insolin ?Insolin)
...
(if(NotifyOrNot >= ?Threshhold 1 ?ShortData ?filepath MS_mergexml_Instance_170026)
then
(undefrule *)
(InterpretationIndex "NO_VALUE")
(Recommendation "调整胰岛素用量或种类")
(Recommendation "1.胰岛素+二甲双胍；调整磺脲类或格列奈类剂量、种类")
(FactUsed "Insolin" "Shuanggua_Drug" "Gelienai_Drug" "Gelietong_Drug" "Huangniao_Drug" "AGI_Drug")
)
)


(defrule MS_MS_mergexml_Instance_170026_1
(filepath ?filepath)
(Huangniao_Drug ?Huangniao_Drug)
(Shuanggua_Drug ?Shuanggua_Drug)
(Gelietong_Drug ?Gelietong_Drug)
...
(defrule MS_MS_mergexml_Instance_170026_2
(filepath ?filepath)
(Gelietong_Drug ?Gelietong_Drug)
(AGI_Drug ?AGI_Drug)
(Shuanggua_Drug ?Shuanggua_Drug)
...
(defrule MS_MS_mergexml_Instance_170026_3
(filepath ?filepath)
=>
...
(defrule MS_MS_mergexml_Instance_170026_4
(filepath ?filepath)
=>
