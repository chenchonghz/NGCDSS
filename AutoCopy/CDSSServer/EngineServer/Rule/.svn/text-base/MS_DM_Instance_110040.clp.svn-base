(defrule MS_DM_Instance_110040_0
(filepath ?filepath)
(HbA1c ?HbA1c)
...
(bind ?CIL410 (Leaf > ?twoHPBG_Variable 8.0 twoHPBG_Variable))
(bind ?RI4 ?CIL410)
(if
(eq ?RI4 TRUE)
then
...
(if(NotifyOrNot >= ?Threshhold 1 ?ShortData ?filepath DM_Instance_110040)
then
(undefrule *)
...
(defrule MS_DM_Instance_110040_1
(filepath ?filepath)
(HbA1c ?HbA1c)
(FBG_Variable ?FBG_Variable)
(twoHPBG_Variable ?twoHPBG_Variable)
...
(if(NotifyOrNot equals ?Threshhold 3 ?ShortData ?filepath DM_Instance_110040)
then
(undefrule *)
(InterpretationIndex "HbA1c<6.5%且FBG 4.4~6.1mmol/l 且2hPBG4.4~8.0mmol/L，治疗方案为1.维持治疗； 2.自我血糖监测，1次/周或静脉血糖， 1次/月; 3.HbA1c检查 1次/3月。")
(Recommendation "1.维持治疗；")
(FactUsed "HbA1c" "FBG_Variable" "twoHPBG_Variable")
)
)
