(defrule MS_Hypertension_Instance_70026_0
(filepath ?filepath)
(Sex ?Sex)
(Age ?Age)
...
(if(NotifyOrNot equals ?Threshhold 0 ?ShortData ?filepath Hypertension_Instance_70026)
then
(undefrule *)
(InterpretationIndex "男性>55岁、女性>65岁、吸烟史、血脂异常、心血管病家族史、肥胖、缺乏体力活动这些危险因素都不符合，继续判断血压几级。")
(load (str-cat ?filepath "MS_Hypertension_Instance_70028.clp"))
(FactUsed "Sex" "Age" "smoke_history" "Dyslipidemia_History" "Cardiovascular_Disease_Family_History" "Fat_History" "lack_of_exercise")
)
)


(defrule MS_Hypertension_Instance_70026_1
(filepath ?filepath)
(Sex ?Sex)
(Age ?Age)
(smoke_history ?smoke_history)
...
(if(NotifyOrNot >= ?Threshhold 1 ?ShortData ?filepath Hypertension_Instance_70026)
then
(undefrule *)
(InterpretationIndex "男性>55岁、女性>65岁、吸烟史、血脂异常、心血管病家族史、肥胖、缺乏体力活动这些危险因素中符合1~2项，继续判断血压几级。")
(load (str-cat ?filepath "MS_Hypertension_Instance_70036.clp"))
(FactUsed "Sex" "Age" "smoke_history" "Dyslipidemia_History" "Cardiovascular_Disease_Family_History" "Fat_History" "lack_of_exercise")
)
)
