(defrule MS_DM_Instance_110113_0
(filepath ?filepath)
(HbA1c ?HbA1c)
=>
(bind ?Threshhold 0)
...
(if(NotifyOrNot equals ?Threshhold 1 ?ShortData ?filepath DM_Instance_110113)
then
(undefrule *)
(InterpretationIndex "7%<=HbA1c<8.5%£¬¼ÌÐøÅÐ¶ÏÊÇ·ñBMI>23¡£")
